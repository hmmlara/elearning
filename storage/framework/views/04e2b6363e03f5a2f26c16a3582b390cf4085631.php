...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                <a href="<?php echo e(route('courses.create')); ?>" class="btn btn-success">Add New Course</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($course->total_topics); ?></td>
                                    <td><?php echo e($course->fee); ?></td>
                                    <th class="d-none d-md-table-cell"><a href="" class="btn btn-success">View</a><a href="<?php echo e(route('courses.edit',$course->id)); ?>" class="btn btn-warning">Edit</a><a href="" class="btn btn-danger">Delete</a></th>
                                </tr>
