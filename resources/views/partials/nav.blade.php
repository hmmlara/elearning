                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ (request()->segment(2) == 'schedules') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('schedules.index') }}">
                            <i class="align-middle" data-feather="table"></i> <span
                    ...
                    <li class="sidebar-item {{ (request()->segment(2) == 'specialities') ? 'active' : '' }} ">
                        <a class="sidebar-link" href="{{route('specialities.index')}}">
                            <i class="align-middle" data-feather="folder"></i> <span class="align-middle">Specialities</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item {{ (request()->segment(2) == 'topics') ? 'active' : '' }} ">
                        <a class="sidebar-link" href="{{route('topics.index')}}">
                            <i class="align-middle" data-feather="list"></i> <span class="align-middle">Topics</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ (request()->segment(2) == 'topicLesson') ? 'active' : '' }} ">
                        <a class="sidebar-link" href="{{route('topicLesson.index')}}">
                            <i class="align-middle" data-feather="list"></i> <span class="align-middle">Topic Lessons</span>
                        </a>
                    </li>
            </div>
        </nav>
