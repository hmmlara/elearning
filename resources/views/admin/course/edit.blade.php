                            ...
                            <div class="row my-3">
                                ...
                                <div class="row my-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="duration" id="" class="form-control" value="{{$course->duration}}">
                                        @error('duration')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="ojt_duration" id="" class="form-control" value="{{$course->ojt_duration}}">
                                        @error('ojt_duration')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    </div>
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="learning_outcome" id="" cols="30" rows="10" class="form-control" >{{$course->learning_outcome}}</textarea>
